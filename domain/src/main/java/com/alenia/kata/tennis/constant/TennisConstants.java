package com.alenia.kata.tennis.constant;
...
public class TennisConstants {
    ...
    public static final String SCORE_FIFTEEN = "15";
    public static final String SCORE_THIRTY = "30";
    public static final String SCORE_FORTY = "40";
